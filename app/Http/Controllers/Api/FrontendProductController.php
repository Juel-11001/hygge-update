...
class FrontendProductController extends Controller
{
    ...
    // All Products (Shop Page, Scroll Load, 16 per page)
    public function allProducts(Request $request)
    {
        $page = $request->get('page', 1);
        $cacheKey = "all_products_page_{$page}_" . md5(json_encode($request->all()));
    ...
    public function categoryProducts($slug, Request $request)
    {
        ...
        $page = $request->get('page', 1);
        $cacheKey = "category_{$category->id}_page_{$page}_" . md5(json_encode($request->all()));
    ...
    // Subcategory & Childcategory Products
    public function subcategoryProducts($slug, Request $request)
    {
    ...
    {
        $page = $request->get('page', 1);
        $cacheKey = "search_products_page_{$page}_" . md5(json_encode($request->all()));
